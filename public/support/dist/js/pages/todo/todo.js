...
$(".add-tsk").click(function (e) {
  ...
  $html =
    ...
    '<a class="edit dropdown-item" href="javascript:void(0);"><div class="d-flex align-items-center"><i data-feather="edit-2" class="feather-sm fill-white text-info me-1"></i>Edit</div></a>' +
    '<a class="important dropdown-item" href="javascript:void(0);"><div class="d-flex align-items-center"><i data-feather="star" class="feather-sm fill-white text-warning me-1"></i>Important</div></a>' +
    '<a class="remove dropdown-item" href="javascript:void(0);"><div class="d-flex align-items-center"><i data-feather="trash-2" class="feather-sm fill-white text-danger me-1"></i>Remove</div></a>' +
    '<a class="dropdown-item permanent-delete" href="javascript:void(0);"><div class="d-flex align-items-center"><i data-feather="trash-2" class="feather-sm fill-white text-danger me-1"></i>Permanent Delete</div></a>' +
    '<a class="dropdown-item revive" href="javascript:void(0);"><div class="d-flex align-items-center"><i data-feather="refresh-cw" class="feather-sm fill-white text-success me-1"></i>Revive Task</div></a>' +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>" +
